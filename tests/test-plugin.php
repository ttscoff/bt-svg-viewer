...
class SVG_Viewer_Tests extends WP_UnitTestCase
{
    ...
    {
        $method = new ReflectionMethod(SVG_Viewer::class, 'get_button_color_style_declarations');
    ...
    {
        $method = new ReflectionMethod(SVG_Viewer::class, 'adjust_color_brightness');
        $method->setAccessible(true);
    ...
    {
        $method = new ReflectionMethod(SVG_Viewer::class, 'build_style_attribute');
        $method->setAccessible(true);
